...
import 'package:sekolah_ku/pages/login_with_bloc/bloc/login_event.dart';
import 'package:sekolah_ku/pages/login_with_bloc/bloc/login_bloc.dart';
import 'package:sekolah_ku/pages/login_with_bloc/bloc/login_state.dart';
...
class LoginPageWithBloc extends StatefulWidget {
  const LoginPageWithBloc({super.key});

  @override
  State<LoginPageWithBloc> createState() => _LoginPageWithBlocState();
}

class _LoginPageWithBlocState extends State<LoginPageWithBloc> {
